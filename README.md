...
An 80×56 custom educational grid, **not SimFire or PROPAGATOR**. Real PNOA aerial imagery of Brunete and Granja Escuela El Álamo, covering approximately 3.84 × 2.69 km (approximately 48 m per cell; cropped geographic area, same grid detail). Town/fictional response base is (10,35), farm (73,21), initial fire (76,41). Roads are simplified centerlines manually traced from the image. Fire, residents, response base and refuges are fictional. Land cover is a coarse hand-authored approximation (fields, scrub, woodland, buildings, roads and bare ground); imagery is not an automatic vegetation classification and suppression ranges/timing remain uncalibrated demo units.
