...
window.AerialView = (() => {
  ...
  function vehicle(c,v,p,drone,time){
    ...
    c.restore();text(c,x-18,y+(drone?-18-(v.role==='scout'?18*Number(v.drone_id.split('-')[1]):0):27),drone?(v.role==='scout'?v.drone_id.toUpperCase():(v.drone_id||'drone-1').toUpperCase()):(v.truck_id||'engine-1').toUpperCase());
