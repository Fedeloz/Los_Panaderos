...
const syncIgniteCursor=()=>$('truth').classList.toggle('can-ignite',canIgnite(state));
$('addFire').onclick=()=>{addingFire=!addingFire;$('addFire').setAttribute('aria-pressed',String(addingFire));$('addFire').textContent=addingFire?'🔥 Click map to ignite · ON':'🔥 Add fire on map';syncIgniteCursor()};
