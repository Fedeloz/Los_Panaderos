(()=>{
  ...
  c.useTranslations({
    es:{pageTitle:'España',kOpenIncidents:'Incidentes abiertos',kCcaa:'CCAA afectadas',kRiskPeople:'Personas en riesgo',kAssetsCommitted:'Medios comprometidos',kLevel:'Nivel',activeEvents:'Expedientes abiertos',closedEvents:'Cerrados',salaHeading:'Sala abierta',salaHelp:'Única sala simulada bajo mando CECOP. Las órdenes proceden de HappyRobot y se muestran sin traducir.',salaClock:'Reloj de sala',lastOrder:'Última orden',openArchive:'Abrir archivo',unwarned:'Sin aviso',
    ...
    en:{pageTitle:'Spain',kOpenIncidents:'Open incidents',kCcaa:'Regions affected',kRiskPeople:'People at risk',kAssetsCommitted:'Assets committed',kLevel:'Level',activeEvents:'Open dossiers',closedEvents:'Closed',salaHeading:'Open room',salaHelp:'The only simulated room under CECOP command. Orders come from HappyRobot and are shown untranslated.',salaClock:'Room clock',lastOrder:'Latest order',openArchive:'Open archive',unwarned:'Unwarned',
